...
- Regroupement en mode `remote` : `NgTableRemoteQuery.groupBy`, en-têtes dessinés sur la page reçue, compte et agrégats fournis par le serveur (`[groupSummaries]`, type `NgTableGroupSummary`), groupes non repliables.
